...
const UIOverlay = ({ totalToday }: { totalToday: number }) => {
  ...
  const dayProgress = passedSeconds / totalSeconds;

  return (
    <div className="fixed inset-0 p-16 ui-overlay flex flex-col justify-between">
      <div>
      ...
      <div className="flex justify-between items-center text-[10px] font-bold text-slate-600 tracking-[0.7em] uppercase">
